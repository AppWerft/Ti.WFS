...
namespace titanium {
	namespace bindings {
		...
		BindEntry* WfsBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.wfs.WfsModule", ::ti::wfs::WfsModule::bindProxy, ::ti::wfs::WfsModule::dispose},
				{"ti.wfs.WFSProxy", ::ti::wfs::wfs::WFSProxy::bindProxy, ::ti::wfs::wfs::WFSProxy::dispose}
			};
